...
-- Co tham khao va su dung mot so ham cua LeQuanVLTK trong cuasotinhoc.vn
---------------------------------------------------------------------------------------
...
tbVulanLib.Move2Item = function(nStartBox,nDestinationBox,szItemName)
    --if nStoreItemPlace  < 1 then return end
    local nRoomType = 0 
    local bRoomExist, nFreeX, nFreeY, nWidth, nHeight = 0, 0, 0, 0, 0
